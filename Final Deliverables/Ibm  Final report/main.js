...
function clearUserCart(addItem, addToCartBtn, trimedEmailID){
    ...
    cartValues.forEach(values => { values.innerHTML = '0';})
    cartTotal.innerHTML = '0';
    if ( window.location != 'file:///C:/Users/NKdugar/Desktop/Project/KIT-canteen-site-master/kit-canteen-site-master/order.html'){
        // Enable removed items btn
        addItem.forEach(item=>{
            addToCartBtn[item.FoodID-1].disabled = false;
            addToCartBtn[item.FoodID-1].innerHTML = 'Add to Cart';
...
function ClientDataFlow(addToCartBtn){
    ...
    firebase.auth().onAuthStateChanged((user) => {
        if (user) {
            ...
            checkOutBtn.addEventListener('click', ()=>{
                ...
                if (addItem.length != 0){
                    ...
                    window.setTimeout(function(){
                        window.location.replace('file:///C:/Users/NKdugar/Desktop/Project/KIT-canteen-site-master/kit-canteen-site-master/order.html')
                    }, 2600)
                } else {
                    Swal.fire({
                        icon: 'error',
            ...
            // Shows Orders
            if (window.location.href === 'file:///C:/Users/NKdugar/Desktop/Project/KIT-canteen-site-master/kit-canteen-site-master/order.html'){
