    ...
    previewNavbar.innerHTML = `
        <div class="container flex text-center jc-ai-center">
            ...
            <div class="site-title flex align-item-center">
                <div>
                    <a href="index.html"><h1><span class="clr-red">KIT</span> <span class="clr-green">Canteen</span></h1></a>
                </div>
                <!-- Toggle Bars -->
...
if (signUpModal){
    ...
    <div class="modal-container">
        ...
        <div class="modal-content">
            <div class="md">Welcome to <br><span class="clr-red md">Kit</span> <span class="clr-green md">Canteen</span></div>
            ...
            <!-- Upper Footer -->
                <main class="grid grid-3">
                    ...
                    <article class="about">
                        ...
                        <p> KARPAGAM INSTITUTE OF TECHNOLOGY ,
                        COIMBATORE .
                        </p>
                         <ul class="py-1">
                             <li><i class="fab fa-facebook-f"></i><a href="https://www.facebook.com/karpagamtechcbe/" target="_blank"> Facebook</a></li>
                             <li><i class="fab fa-instagram"></i><a href="https://www.instagram.com/_karpagam_itech/?igshid=17s0aite80blo" target="_blank">Instagram</a></li>
                         </ul>
                    </article>
                    <!-- Navigation Links -->
                    <article class="quick-links">
                         <ul>
                             ...
                             <li><a href="index.html">Canteen Home</a></li>
                              <li><a href="our-vision.html">Our Vision</a></li>
                             <li><a href="BLANK" target="_blank">Git Repository</a></li>
                             <li><a href="https://karpagamtech.ac.in/" target="_blank">KIT Cbe</a></li>
                         </ul>
                    </article>
                    <!-- Contact Details -->
                    <article class="contact">
                        <ul>
                            ...
                            <li> <i class="fas fa-phone-alt"></i> <p>+91-0123456789</p></li>
                            <li> <i class="fas fa-envelope"></i> <p>KIT Coimbatore</p></li>
                            <li> <i class="fas fa-map-marker-alt"></i> <a href="https://www.google.com/maps/place/Karpagam+Institute+of+Technology/@10.9082607,76.9763806,17z/data=!3m1!4b1!4m5!3m4!1s0x3ba85ae942396eef:0xf18c9eb8f29896d8!8m2!3d10.9082607!4d76.9785693">KARPAGAM,CBE</li>
                            <li> <i class="fas fa-globe-asia"></i> <p>contact KIT</p></li>
                        </ul>
                    </article>
                </main>
                <!-- Deep Devs Info -->
                <main class="deep-devs flex">
                    ...
                    <div class="">Designed & Developed with <i class="fas fa-heart clr-red"></i> By <a href="#">Nkd & Co.</a></div>
                </main>
            </section>
        `;
        })
			...
			COIMBATORE.</p>
                    ...
                    <article class="quick-links">
                        <ul>
                            ...
                            <li><a href="Blank" target="_blank">Git Repository</a></li>
                            <li><a href="https://karpagamtech.ac.in/" target="_blank">kit</a></li>
                        </ul>
                    </article>
                    <!-- Contact Details -->
                    <article class="contact">
                        <ul>
                            <h1 class="sm">Contact Information</h1>
                            <li> <i class="fas fa-phone-alt"></i> <p> +91-0123456789 </p></li>
                            <li> <i class="fas fa-envelope"></i> <p>admission@KARPAGAM.co.in</p></li>
                            <li> <i class="fas fa-map-marker-alt"></i> <p>COIMBATORE * 641006</p></li>
                            <li> <i class="fas fa-globe-asia"></i> <p>For Professional Courses, Visit: KARPAGAM INSTITTUE</p></li>
                        </ul>
                    </article>
                </main>
                <!-- Deep Devs Info -->
